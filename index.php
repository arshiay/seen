...
ربات اصلی:
333222111:fdkjflsSDFLSDmdlsjkvjfjknfFDnfjdk
ربات فرعی:
111222333:ffdslkjflksjfdKSDknfdfdvjkfdnfjdf
...
و سپس به درون index.php رفته و به جای @CHANNELUSERNAME آیدی کانال خود را وارد کنید.☺️

اگر میخواهید که برا کانال آیدی نگذازید میتوانید آیدی عددی کانال را جایگزین نام کاربر کانال کنید

برای دریافت آیدی خود و کانال از دستور /id استفاده نمایید 
...
",
    ...
    }elseif(preg_match('/^\/([Ff]ortoall)/',$txt) &&  $from == $admin){
        $ttxtt = file_get_contents('CountMem.txt');
        $membersidd= explode("\n",$ttxtt);
...
$texin = $update->inline_qurey->qurey;
if($texin == ""){
...
Best friend $first_name"],
            ...
            'input_message_content'=>['parse_mode'=>'HTML','message_text'=>"کانال جوکدونی ، کانال خنده و شادی☺️

کانالی پر از جوک خنده دار☺️ ، اس ام اس✉️،دیالوگ فیلم های خنده دار ایرانی و خارجی

برای عضوت در کانال 🔧 از دکمه های زیر استفاده کن:"],
            'reply_markup'=>[
                'inline_keyboard'=>[
                    [
                        ['text'=>"Join Channel | عضویت در کانال",'url'=>'https://telegram.me/joinchat/EzUIy0AnWqQZgiA_w-I7lA']
                    ],
                    [
                        ['text'=>"Share | اشتراک",'switch_inline_query'=>'']
                    ]
